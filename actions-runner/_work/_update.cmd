...
set rootfolder=I:\TuminhAgi\actions-runner
set existrunnerversion=2.314.1
set downloadrunnerversion=2.332.0
set logfile=I:\TuminhAgi\actions-runner\_diag\SelfUpdate-20260316-154545.log
...
if %restartinteractiverunner% equ 1 (
  ...
  endlocal
  start "Actions Runner" cmd.exe /k "I:\TuminhAgi\actions-runner\run.cmd"
) else (
  endlocal
)
